...
RECEIPT_EXTRACTION_PROMPT = (
    ...
    "IMPORTANT: For items with quantities (e.g., '2 @ 3.94' or '3 x 5.99'), "
    "extract the UNIT PRICE (3.94 or 5.99), NOT the line total. "
    "We want the price per single item for price comparison. "
